        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('user.tickets') }}">Tickets</a></li>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ticket_id" name="ticket_id" readonly value="TICKET/{{ $month }}/{{ $year }}/{{ $urutan }}">
                    </div>
                    @error('ticket_id')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="department" name="department" readonly value="{{ $department }}">
                    </div>
                    @error('department')
                        <div class="invalid-feedback">
                            {{ $message }}
